...
val show_poly_type_constraint : poly_type_constraint -> string

val show_mono_type_constraint_reference : mono_type_constraint_reference -> string

val show_poly_type_constraint_selection : DisplayMap.t -> poly_type_constraint_selection -> string
